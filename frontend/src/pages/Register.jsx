            ...
            <div className="w-full lg:w-7/12 flex flex-col justify-center items-center p-8 lg:p-12 overflow-y-auto">
                ...
                <div className="w-full max-w-lg animate-slide-up">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-6">
                        <button onClick={() => window.location.href = 'http://localhost:8083/oauth2/authorization/google'} className="btn-secondary text-sm py-2.5">
                        ...
                        <button onClick={() => window.location.href = 'http://localhost:8083/oauth2/authorization/github'} className="btn-secondary text-sm py-2.5">
